...
| **Method** | Read-only multi-agent workflow: 6-lens map → adversarial verify (gap-real? invariant-sound?) → dedupe/rank synthesis. 69 agents; 62 candidates raised (26 confirmed / 34 refuted / 2 uncertain) → 17 prioritized + 18 well-covered scopes. |
